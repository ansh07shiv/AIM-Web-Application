                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    required
                                    fullWidth
                                    id="lastName"Sign upSign upSign up
                                    label="Last Name"
                                    name="lastName"
                                    onChange={formik.handleChange}
                            ...
                            <Grid item xs={12}>
                                <Autocomplete
                                    ...
                                    onChange={(event, newValue) => {
                                        formik.setFieldValue('degree', newValue.value);
                                    }}
                                    options={[{label: "Masters", value: "Masters"}, {label: "Bachelors", value: "Bachelors"}]}
                                    renderInput={(params) => <TextField  {...params} required label="Degree" />}
                                />
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
